...
public class MediaMetadataJson
{
    ...
    public static Result<MediaMetadataJson> Create(string? file)
    {
        ...
        {
            MediaType.QuickTimeMov => QuickTimeMediaFileContainer.Create(fileInfoContainerResult.Value.File.FullName)
            ...
            MediaType.Mpeg4 => Mpeg4MediaFileContainer.Create(file)
